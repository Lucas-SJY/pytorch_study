...
#all data are downloaded via - https://www.kaggle.com/competitions/house-prices-advanced-regression-techniques/data?select=test.csv
...
def log_rmse(net, features, labels):
    ...
    return rmse.item()
def train(net, train_features, train_labels, test_features, test_labels, num_eopchs, learning_rate, weight_decay, batch_size):
    train_ls, test_ls = [], []
